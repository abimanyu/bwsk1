							...
							while ($row = $sql-> db_Fetch()) {
							    ...
							    <tr>
							        ...
							        <td><a href='#edit' class='text-bold'>".$row['c_name']."</a>
							        	...
							        	<a href='#modalAnim' data-id=\"".$row['PCAT_ID']."\" class=\"delete-row modal-with-move-anim\">Delete</a>
							        	</p>
							        </td>
							        <td>".$row['slug']."</td>
								...
								<footer class="panel-footer">
									<div class="row">
										<div class="col-md-12 text-right">
											...
											<button id="PCAT_ID" data-id="" class="btn btn-primary modal-confirm">Confirm</button>
