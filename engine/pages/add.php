...
if(isset($_POST['form_submit'])) {
	...
	if (!empty($_POST['title'])) {
		...
		$ID = $sql -> db_Insert("PAGES", "'', '".$rw."', '".$_POST['title']."', '".$_POST['T_ID']."', '".U_ID."', '".$STATUS_POST."', '0', '".$STATUS_POST."', NOW(), ".$PUBLISH_DATE." , NOW() ");
...
<div class="col-md-8">
	...
	<section class="panel panel-transparent">
		<div class="panel-body">
			...
			<div class="form-group">
				<div class="col-md-12">
					<textarea class="summernote" id="article" name="article" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "mode": "text/html", "htmlMode": "true", "lineNumbers": "true", "theme": "monokai" } }'></textarea>
				</div>
			</div>
		</div>
	</section>
