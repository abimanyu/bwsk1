				...
				<div class="panel-body bg-primary">
					<div class="widget-summary">
						...
						<div class="widget-summary-col">
							<div class="summary">
								<h4 class="title">Ganti password Anda Secara Berkala</h4>
								<div class="info">
							...
							<div class="summary-footer">
								<a class="text-uppercase">(Password Anda Berumur 102 hari)</a>
							</div>
						</div>
					</div>
				</div>
